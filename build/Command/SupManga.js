...
exports.SupManga = {
    ...
    run: function (client, interaction) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            nom = nom === null || nom === void 0 ? void 0 : nom.toString().replaceAll(" ", "-").toLowerCase();
            supabase_1.BDD.getManga(nom).then(function (manga) {
                ...
                if (manga.length === 0) {
                    ...
                    supabase_1.BDD.getManga(nom).then(function (manga) {
                        supabase_1.BDD.supprimerManga(manga[0].name_manga).then(function () { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, supabase_1.BDD.supImgFromTest(manga[0].name_manga)];
                                    case 1:
                                        _a.sent();
                                        interaction.followUp({
                                            ephemeral: true,
