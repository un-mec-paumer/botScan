...
interface ModelSource { // je sais que c'est moche 
    ...
    // name: string; // et que si on devi juste un peu c'est erreur de deserilization a gogo
    // link: string; // sois on change le model prisma pour que ca corresponde a ce qu'on veut, sois on fait du moche comme ca
