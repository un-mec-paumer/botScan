...
export class AlertService {
  ...
  async addAlert(userId: string, workId: number, mangaAlert: boolean = false, animeAlert: boolean = false) {
  ...
  async updateAlert(userId: string, workId: number, mangaAlert: boolean | null = null, animeAlert: boolean | null = null) {
